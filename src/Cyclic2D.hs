...
cellToDiagram Cell{val=0, ..}  = (rect 1 4# fc (sRGB24read "#1abc9c"))
cellToDiagram Cell{val=1, ..} = (rect 1 4 # fc (sRGB24read "#f1c40f"))
cellToDiagram Cell{val=2, ..} = (rect 1 4 # fc (sRGB24read "#e67e22"))
cellToDiagram Cell{val=3, ..} = (rect 1 4 # fc (sRGB24read "#9b59b6"))
cellToDiagram Cell{val=4, ..} = (rect 1 4 # fc (sRGB24read "#2c3e50"))
cellToDiagram Cell{..} = square 1 # fc (sRGB f (1.0 - f) 0.0) where
                            f = (fromIntegral val / fromIntegral total)
